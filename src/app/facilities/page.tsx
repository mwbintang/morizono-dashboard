...
const facilities = [
  {
    ...
    description:
      "Sistem keamanan terpadu dengan CCTV dan petugas keamanan profesional yang berjaga selama 24 jam untuk kenyamanan dan ketenangan Anda.",
  },
  {
    icon: School,
    title: "Sekolah & Universitas",
    description:
      "Akses mudah ke berbagai institusi pendidikan berkualitas mulai dari TK hingga universitas ternama dalam radius dekat.",
  },
  {
    icon: ShoppingBag,
    title: "Pusat Perbelanjaan",
    description:
      "Dekat dengan mall, supermarket, dan berbagai pusat perbelanjaan untuk memenuhi kebutuhan sehari-hari Anda.",
  },
  {
    icon: Heart,
    title: "Fasilitas Kesehatan",
    description:
      "Rumah sakit, klinik, dan apotek tersedia di sekitar area untuk kemudahan akses layanan kesehatan.",
  },
  {
    icon: Trees,
    title: "Taman & Ruang Hijau",
    description:
      "Taman bermain anak, jogging track, dan ruang terbuka hijau untuk gaya hidup sehat dan rekreasi keluarga.",
  },
  {
    icon: Building2,
    title: "Area Komersial",
    description:
      "Kawasan bisnis dan perkantoran yang terintegrasi memberikan kemudahan aksesibilitas untuk bekerja.",
  },
  {
    icon: Car,
    title: "Akses Transportasi",
    description:
      "Lokasi strategis dengan akses mudah ke tol, stasiun kereta, dan berbagai moda transportasi publik.",
  },
  {
    icon: Dumbbell,
    title: "Fasilitas Olahraga",
    description:
      "Dilengkapi dengan fasilitas olahraga seperti kolam renang, lapangan basket, dan fitness center.",
  },
];
...
const Facilities = () => {
  ...
  useEffect(() => {
    ...
    document.title = `${t("facilities.title")} - Morizono - Gardens`;
