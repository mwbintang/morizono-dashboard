...
const testimonials = [
  {
    ...
    content: "Pelayanan yang sangat memuaskan dari awal konsultasi hingga serah terima. Rumah sesuai dengan yang dijanjikan dan prosesnya sangat transparan.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Tim yang profesional dan responsif. Membantu saya menemukan rumah impian dengan lokasi strategis dan harga yang sesuai budget.",
    rating: 5,
    image: "/placeholder.svg"
  },
  {
    ...
    content: "Proses pembelian yang mudah dan cepat. Dokumentasi lengkap dan legal jelas. Sangat puas dengan kualitas bangunannya.",
    rating: 5,
    image: "/placeholder.svg"
  },
  {
    ...
    content: "Fasilitas lengkap dan lingkungan sangat nyaman. After sales service juga sangat baik, selalu siap membantu jika ada pertanyaan.",
    rating: 5,
    image: "/placeholder.svg"
  }
];
      ...
      <div className="min-h-screen">
        ...
        <main className="pt-24 pb-16">
          ...
          <section className="bg-gradient-to-br from-primary/5 to-accent/5 py-20">
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center animate-fade-in-up">
                ...
                <h1 className="text-4xl md:text-5xl font-bold mb-6">{t('awards.title')}</h1>
          ...
          <section className="py-16">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-4">{t('awards.ourAwards')}</h2>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <h3 className="text-xl font-bold mt-1 mb-2">{award.title}</h3>
          ...
          <section className="py-16 bg-secondary/30">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-4">{t('awards.testimonials')}</h2>
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  {t('awards.subtitle')}
                </p>
              </div>
