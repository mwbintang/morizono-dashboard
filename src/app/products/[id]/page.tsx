...
const ProductDetail = () => {
  ...
  const product = {
    ...
    type: "ready",
    description:
      "Rumah modern minimalis dengan desain kontemporer yang elegan. Terletak di kawasan BSD City yang strategis dengan akses mudah ke berbagai fasilitas. Lingkungan asri dan aman dengan keamanan 24 jam.",
    facilities: [
      "Carport 2 mobil",
              ...
              <div className="space-y-4 animate-fade-in">
                ...
                <div className="grid grid-cols-3 gap-4">
                  {product.images.slice(1).map((img, index) => (
                    <div
                      key={index}
                      className="relative h-32 rounded-lg overflow-hidden shadow-soft"
                    >
                      <Image
                        src={img}
